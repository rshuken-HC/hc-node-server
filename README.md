# Harbor Non-Profit Server Tech: Node - Koa - Typescript
...
| **node_modules**                    | Contains all your yarn/npm  dependencies                                                            |
...
To install or update these dependencies you can use `yarn install` or `yarn upgrade`.
